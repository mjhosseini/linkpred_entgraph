...
class Config:
    ...
    process = False
    model_name = None
    mode = 'train' #train, probs, test, test_entgraphs
    entgraph_path = ''
    probs_file_path = 'probs.txt'
    load = False
...
params2type['mode'] = lambda x: x
params2type['entgraph_path'] = lambda x: x
params2type['probs_file_path'] = lambda x: x
params2type['load'] = lambda x: x.lower() == 'true' or x == '1'
...
params2field['mode'] = lambda x: setattr(Config, 'mode', x)
params2field['entgraph_path'] = lambda x: setattr(Config, 'entgraph_path', x)
params2field['probs_file_path'] = lambda x: setattr(Config, 'probs_file_path', x)
params2field['load'] = lambda x: setattr(Config, 'load', x)
